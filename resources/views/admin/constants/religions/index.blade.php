                ...
                <div class="portlet light ">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase"> Religions</span>
                        </div>
                    </div>
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="{{url(admin_constants_url().'/religion-create')}}" class="btn sbold green"><i
...
@section('js')
    ...
    <script src="{{url(assets('admin'))}}/js/religions.js" type="text/javascript"></script>
