...
use App\Hobby;
use App\HobbyTranslation;
use App\Religion;
use App\ReligionTranslation;
use App\Repositories\Interfaces\Repository;
use App\Repositories\Uploader;
use Illuminate\Support\Facades\Config;

class ReligionEloquent extends Uploader implements Repository
{

    private $model, $translation;

    public function __construct(Religion $model, ReligionTranslation $translation)
    {
        $this->model = $model;
    ...
    function anyData()
    {
        ...
        return datatables()->of($data)
            ->addColumn('name', function ($item) {
                ...
                return '
                                    <a href="' . url(admin_constants_url() . '/religion-edit/' . $item->id) . '" class="btn btn-circle btn-icon-only purple edit">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <a href="' . url(admin_constants_url() . '/religion/' . $item->id) . '" class="btn btn-circle btn-icon-only red delete">
