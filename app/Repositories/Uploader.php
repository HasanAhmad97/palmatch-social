...
//
    ...
    public function storeImageThumb_($folder, $id, $image,$type)
    {
    ...
    public function storeGallaryThumb($folder, $id,$photo_id, $image)
    {
        $filename = $photo_id . time() . '.' . $image->getClientOriginalExtension();
