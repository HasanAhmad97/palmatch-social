                ...
                <div class="portlet light ">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            <i class="fa fa-caret-up font-dark"></i>
                            <span class="caption-subject bold uppercase"> Interests</span>
                        </div>
                    </div>
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="{{url(admin_constants_url().'/interest-create')}}" class="btn sbold green"><i
...
@section('js')
    ...
    <script src="{{url(assets('admin'))}}/js/interests.js" type="text/javascript"></script>
