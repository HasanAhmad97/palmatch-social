...
@section('content')
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-md-9">
                                                <div class="fileinput fileinput-new" data-provides="fileinput  ">
                                                    <div>
                                                        <select class="form-control input-md select2" name="country_id" id="country_id" data-placeholder="Choose Question" >
                                                            <option value="">Choose Question</option> @foreach($countries as $country)
                                                            <option  @if($city->country_id == $country->id) 
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" name="title[{{$key}}]" id="title"
                                                                   value="{{$city->translation($key)->name}}"
                                                                   class="form-control"
    ...
    @section('js')
        <!-- BEGIN THEME GLOBAL SCRIPTS -->
            ...
            <script src="{{url(assets('admin'))}}/js/cities.js" type="text/javascript"></script>
