                                            ...
                                            <div class="col-md-9">
                                                <div class="mt-radio-inline">
                                                    <label class="mt-radio">
                                                        <input type="radio" name="duration_type" id="duration_type1" value="month" checked="">Monthly
                                                        <span></span>
                                                    </label>
                                                    <label class="mt-radio">
                                                        <input type="radio" name="duration_type" id="duration_type2" value="year" >Yearly
                                                        <span></span>
                                                    </label>
