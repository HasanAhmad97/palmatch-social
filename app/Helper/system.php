...
function admin_Subscriptions_url()
{
    return 'admin/emailSubscriptions';
}
function admin_Subscriptions_vw()
{
    return admin_vw() . '.emailSubscriptions';
}
...
function admin_contactus_url()
{
    return 'admin/contactus';
}

function admin_contactus_vw()
{
    return 'admin.contactus';
}
