                                ...
                                @foreach($form['fields'] as $key => $fields)
                                    @if($fields == 'image' || $fields == 'video')
                                        <div class="form-group ">
                                            <label
                                                class="control-label col-md-3">{{ucfirst($form['fields_name'][$key])}}</label>
                                            <div class="col-md-9">
                                    ...
                                    @if($fields == 'file')
                                        <div class="form-group">
                                            <label
                                                class="col-md-3 control-label">{{ucfirst($form['fields_name'][$key])}}</label>
                                            <div class="col-md-9">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @else
                                                <label
                                                    class="col-md-3 control-label">{{ucfirst($form['fields_name'][$key])}}</label>
                                                <div class="col-md-9">
                                                <textarea name="{{$key}}" id="{{$key}}" rows="5" required
                                                          placeholder="{{$form['fields_name'][$key]}}"
                                                          class="form-control">@if(isset($form['values'])){{$form['values'][$key]}}@endif</textarea>
                                                </div>
                                            @endif
