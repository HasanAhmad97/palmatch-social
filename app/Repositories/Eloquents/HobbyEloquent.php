...
class HobbyEloquent extends Uploader implements Repository
{

    private $model, $translation;

    public function __construct(Hobby $model, HobbyTranslation $translation)
    {
        $this->model = $model;
    ...
    function anyData()
    {
        ...
        return datatables()->of($data)
            ->addColumn('name', function ($item) {
                ...
                return '
                                    <a href="' . url(admin_constants_url() . '/hobby-edit/' . $item->id) . '" class="btn btn-circle btn-icon-only purple edit">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <a href="' . url(admin_constants_url() . '/hobby/' . $item->id) . '" class="btn btn-circle btn-icon-only red delete">
