...
@section('content')
                ...
                <div class="portlet light ">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase"> Stories</span>
                        </div>
                    </div>
                                            ...
                                            <div class="col-md-9">
                                                <div class="fileinput fileinput-new"
                                                    ...
                                                    <div class="fileinput-preview thumbnail"
                                                        ...
                                                        <img
                                                            src="{{$story->image ?? url('assets/apps/img/unknown.png')}}"
                                                            alt=""/>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" name="title[{{$key}}]" id="title"
                                                                   value="{{$story->translation($key)->title}}"
                                                                   class="form-control"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                                <textarea type="text" name="description[{{$key}}]"
                                                                          ...
                                                                          class="form-control"
                                                                          rows="5"
                                                                          placeholder="Add description ({{$lang}})...">{{$story->translation($key)->description}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    @section('js')
        <!-- BEGIN THEME GLOBAL SCRIPTS -->
            ...
            <script src="{{url(assets('admin'))}}/js/stories.js" type="text/javascript"></script>
